...
export default function Header() {
  ...
  <nav className="hidden md:flex md:grow">
    <ul className="flex grow justify-end flex-wrap items-center">
      <li>
        {/* <Link href="/demo" className="text-gray-600 hover:text-gray-900 px-3 lg:px-5 py-2 flex items-center transition duration-150 ease-in-out">Tailor Resume</Link> */}
        <Link href="/tailor-resume" className="btn-sm text-gray-200 bg-gray-900 hover:bg-gray-800 ml-3">
