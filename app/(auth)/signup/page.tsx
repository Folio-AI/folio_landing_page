        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="max-w-sm mx-auto">
            <form>
              ...
              <div className="flex flex-wrap -mx-3 mt-6" data-aos="zoom-y-out" data-aos-delay="450">
                <div className="w-full px-3">
            ...
            <div className="text-gray-600 text-center mt-6">
              Already using Folio? <Link href="/signin" className="text-blue-600 hover:underline transition duration-150 ease-in-out">Sign in</Link>
            </div>
          </div>
